<?php namespace IOProject\Accountancy\ContractSalary\MandatoryContract;

use IOProject\Core\Common;
use IOProject\Accountancy\Tax;
use IOProject\Accountancy\Enums\TaxValueType;

class MandatoryContractTaxCalculation extends \IOProject\Accountancy\ContractSalary\ContractTaxCalculation {
